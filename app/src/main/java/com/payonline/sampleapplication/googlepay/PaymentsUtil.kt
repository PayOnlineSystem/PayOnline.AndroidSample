package com.payonline.sampleapplication.googlepay

import android.app.Activity
import com.google.android.gms.wallet.PaymentsClient
import com.google.android.gms.wallet.Wallet
import com.payonline.sampleapplication.GooglePayConfig
...
object PaymentsUtil {
    ...
    private fun gatewayTokenizationSpecification(): JSONObject {
        if (GooglePayConfig.PAYMENT_GATEWAY_TOKENIZATION_PARAMETERS.isEmpty()) {
        ...
        return JSONObject().apply {
            ...
            put("parameters", JSONObject(GooglePayConfig.PAYMENT_GATEWAY_TOKENIZATION_PARAMETERS))
        }
    }
     ...
     */
    private val allowedCardNetworks = JSONArray(GooglePayConfig.SUPPORTED_NETWORKS)
     ...
     * @see [CardParameters](https://developers.google.com/pay/api/android/reference/object.CardParameters)
     */
    private val allowedCardAuthMethods = JSONArray(GooglePayConfig.SUPPORTED_METHODS)
    ...
    fun createPaymentsClient(activity: Activity): PaymentsClient {
        val walletOptions = Wallet.WalletOptions.Builder()
            .setEnvironment(GooglePayConfig.PAYMENTS_ENVIRONMENT)
            .build()
    ...
    private fun getTransactionInfo(price: String): JSONObject {
        return JSONObject().apply {
            ...
            put("countryCode", GooglePayConfig.COUNTRY_CODE)
            put("currencyCode", GooglePayConfig.CURRENCY_CODE)
        }
    }
        ...
        try {
            return JSONObject(baseRequest.toString()).apply {
                ...
                val shippingAddressParameters = JSONObject().apply {
                    ...
                    put("allowedCountryCodes", JSONArray(GooglePayConfig.SHIPPING_SUPPORTED_COUNTRIES))
                }
